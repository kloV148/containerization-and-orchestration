...
**Включение из будушего**

Структура helmfile была просто вынесена в корень, переменные будут переиспользованы в следующих лабораторных.
Сами переменные и шаблоны могут слегка отличаться от таковых на момент написания отчета. 
Если изменения серьезные, то буду оставлять прошлую версию values для демонстрации в отчете
